...
GameTag.LINKEDCARD = GameTag.LINKED_ENTITY
...
-- Add Deleted Tags
GameTag.IGNORE_DAMAGE = 1
GameTag.COPY_DEATHRATTLE_INDEX = 56
GameTag.DIVINE_SHIELD_READY = 314
GameTag.IGNORE_DAMAGE_OFF = 354
GameTag.NUM_OPTIONS = 359
-- PlayReqs
local PlayReqTag = {
	REQ_MINION_TARGET = 1,
